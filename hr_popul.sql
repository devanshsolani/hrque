...
INSERT INTO employees VALUES 
        ...
        , 'SKING'
        , '515.123.4567'
        , TO_DATE('17-JUN-2017', 'dd-MON-yyyy')
        , 'AD_PRES'
        , 24000
        , NULL
        , NULL
...
INSERT INTO employees VALUES 
        ...
        , 'AHUNOLD'
        , '590.423.4567'
        , TO_DATE('03-JAN-2020', 'dd-MON-yyyy')
        , 'IT_PROG'
        , 9000
        , NULL
        , 102
...
INSERT INTO employees VALUES 
        ...
        , 'BERNST'
        , '590.423.4568'
        , TO_DATE('21-MAY-2021', 'dd-MON-yyyy')
        , 'IT_PROG'
        , 6000
        , NULL
        , 103
...
INSERT INTO employees VALUES 
        ...
        , 'TGATES'
        , '650.505.3876'
        , TO_DATE('11-JUL-2016', 'dd-MON-yyyy')
        , 'SH_CLERK'
        , 2900
        , NULL
        , 122
...
INSERT INTO employees VALUES 
        ...
        , 'AWALSH'
        , '650.507.9811'
        , TO_DATE('24-APR-2016', 'dd-MON-yyyy')
        , 'SH_CLERK'
        , 3100
        , NULL
        , 124
...
INSERT INTO employees VALUES 
        ...
        , 'KFEENEY'
        , '650.507.9822'
        , TO_DATE('23-MAY-2016', 'dd-MON-yyyy')
        , 'SH_CLERK'
        , 3000
        , NULL
        , 124
...
INSERT INTO employees VALUES 
        ...
        , 'SMAVRIS'
        , '515.123.7777'
        , TO_DATE('07-JUN-2022', 'dd-MON-yyyy')
        , 'HR_REP'
        , 6500
        , NULL
        , 101
...
INSERT INTO employees VALUES 
        ...
        , 'SHIGGINS'
        , '515.123.8080'
        , TO_DATE('07-Nov-2022', 'dd-MON-yyyy')
        , 'AC_MGR'
        , 12000
        , NULL
        , 101
...
UPDATE employees SET end_date ='12-JAN-2022'WHERE employee_id=101;
UPDATE employees SET end_date ='18-MAY-2022'WHERE employee_id=201;
UPDATE employees SET end_date ='05-APR-2019'WHERE employee_id=114;
UPDATE employees SET end_date ='31-JUL-2021'WHERE employee_id=122;
UPDATE employees SET end_date ='24-SEP-2022'WHERE employee_id=176;
UPDATE employees SET end_date ='10-AUG-2021'WHERE employee_id=200;
